...
SECRET_KEY = '3zk+*re+o^ffde*3u5a%ekwyv@vv8$90qo7&)8m+e720z110fc'
...
# media root and urls defined for media files.

STATIC_URL = '/static/'
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'Face_Recognition/FaceApp/static/'),
